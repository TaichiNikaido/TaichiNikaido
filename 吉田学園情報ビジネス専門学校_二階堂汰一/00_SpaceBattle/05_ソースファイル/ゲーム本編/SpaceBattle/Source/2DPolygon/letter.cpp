...
// マクロ定義
//*****************************************************************************
#define TEXTURE_PASS ("Data/Texture/alphabet001.png")	//テクスチャのパス
...
void CLetter::Update(void)
{
	...
	m_pVtxBuff->Lock(0, 0, (void**)&pVtx, 0);
	//頂点カラーの設定
	pVtx[0].col = D3DXCOLOR(1.0f, 0.5f, 0.0f, m_fAlpha);
	pVtx[1].col = D3DXCOLOR(1.0f, 0.5f, 0.0f, m_fAlpha);
	pVtx[2].col = D3DXCOLOR(1.0f, 0.5f, 0.0f, m_fAlpha);
	pVtx[3].col = D3DXCOLOR(1.0f, 0.5f, 0.0f, m_fAlpha);
	//頂点バッファのアンロック
	m_pVtxBuff->Unlock();
}
