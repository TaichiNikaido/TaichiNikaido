...
// マクロ定義
//*****************************************************************************
#define TEXTURE ("Data/Texture/warning.png")			//テクスチャのパス
#define SIZE (D3DXVECTOR3(920.0f,270.0f,0.0f))			//サイズ
#define RED_COLOR (D3DXCOLOR(1.0f,0.0f,0.0f,1.0f))		//赤色
#define YELLOW_COLOR (D3DXCOLOR(1.0f,1.0f,0.0f,1.0f))	//黄色
#define MINIMUM_COLOR_CHANGE_TIME (0)					//色変更時間の最小値
#define MINIMUM_COLOR_CHANGE_COUNT (0)					//色変更カウントの最小値
#define INIT_POSITION (D3DXVECTOR3(DragonPosition.x, PlayerPosition.y, 0.0f))	//位置の初期値
#define COLOR_CHANGE_TIME (10)							//色変更時間
#define COLOR_CHANGE_COUNT (2)							//色変更カウント
