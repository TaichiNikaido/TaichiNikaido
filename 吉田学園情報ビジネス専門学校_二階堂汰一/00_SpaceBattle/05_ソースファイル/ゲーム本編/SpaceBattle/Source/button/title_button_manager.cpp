...
// マクロ定義
//*****************************************************************************
#define START_BUTTON_POSITION (D3DXVECTOR3(SCREEN_WIDTH / 2 + 460.0f, 740.0f, 0.0f))	//スタートボタンの位置
#define REPLAY_BUTTON_POSITION (D3DXVECTOR3(SCREEN_WIDTH / 2 + 460.0f, 840.0f, 0.0f))	//リプレイボタンの位置
#define EXIT_BUTTON_POSITION (D3DXVECTOR3(SCREEN_WIDTH / 2 + 460.0f, 940.0f, 0.0f))		//終了ボタンの位置
