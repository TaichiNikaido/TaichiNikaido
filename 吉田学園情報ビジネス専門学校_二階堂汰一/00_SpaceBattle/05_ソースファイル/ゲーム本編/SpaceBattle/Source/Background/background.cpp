...
// マクロ定義
//*****************************************************************************
#define MINIMUM_MOVE (0.0f)			//移動量の最小値
...
void CBackground::Update(void)
{
	...
	aTexture[0] = D3DXVECTOR2(0.0f, -m_nPatternAnime * m_fMoveValue);
	aTexture[1] = D3DXVECTOR2(1.0f, -m_nPatternAnime * m_fMoveValue);
	aTexture[2] = D3DXVECTOR2(0.0f, -m_nPatternAnime * m_fMoveValue + 1.0f);
	aTexture[3] = D3DXVECTOR2(1.0f, -m_nPatternAnime * m_fMoveValue + 1.0f);
	//テクスチャの設定
	SetTexture(aTexture);
}
