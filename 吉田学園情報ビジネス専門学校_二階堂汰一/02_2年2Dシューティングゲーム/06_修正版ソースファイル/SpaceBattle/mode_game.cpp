...
void CGameMode::CreateAll(void)
{
	...
	CEnemyEyeNormal::Create(D3DXVECTOR3(800.0f,600.0f,0.0f));
	CEnemyEyeHard::Create(D3DXVECTOR3(900.0f, 600.0f, 0.0f));
	CEnemySpider::Create(D3DXVECTOR3(1000.0f, 100.0f, 0.0f));
}