...
// 初期化処理
//=============================================================================
HRESULT CInputJoystick::InitInput(HINSTANCE hInstance, HWND hWnd)
{
	HRESULT  hr;

	hr = CInput::InitInput(hInstance, hWnd);
...
// 終了処理
//=============================================================================
void CInputJoystick::UninitInput(void)
{
	CInput::UninitInput();
	if (m_pJDevice != NULL)
	{
...
// 更新処理
//=============================================================================
void CInputJoystick::UpdateInput(void)
{
	int nCntKey;
	DIJOYSTATE js;
