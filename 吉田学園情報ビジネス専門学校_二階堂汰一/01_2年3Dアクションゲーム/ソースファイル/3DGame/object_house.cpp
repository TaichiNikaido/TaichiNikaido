...
// 静的メンバ変数の初期化
//*****************************************************************************
CModel::MODEL_DATA CHouse::m_ModelData = {};			//モデルデータのポインタ
D3DXMATERIAL * CHouse::m_pMaterial = NULL;				//マテリアルのポインタ
